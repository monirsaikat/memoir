(() => {
  ...
  const THEME_MODES = { light: 'light', dark: 'dark', sepia: 'light', ocean: 'dark', midnight: 'dark', forest: 'dark', dusk: 'dark', aurora: 'dark', paper: 'light', nord: 'dark', soft: 'light', velvet: 'dark', linen: 'light' };
